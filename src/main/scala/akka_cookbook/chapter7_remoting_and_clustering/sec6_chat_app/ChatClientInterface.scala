...
import akka_cookbook.chapter7_remoting_and_clustering.sec6_chat_app.ChatClientInterface.Check
import akka_cookbook.chapter7_remoting_and_clustering.sec6_chat_app.ChatServer.Disconnect
